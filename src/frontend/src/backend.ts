...
import type { Habit as _Habit, HabitLog as _HabitLog, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addHabit(arg0: string, arg1: string): Promise<Habit> {
        if (this.processError) {
            try {
    ...
    async generateShareToken(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateShareToken();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerLogs(arg0: string, arg1: string, arg2: string): Promise<Array<HabitLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerLogs(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHabitHistory(arg0: string, arg1: string, arg2: string): Promise<Array<HabitLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHabitHistory(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHabitsForUser(arg0: Principal): Promise<Array<Habit>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHabitsForUser(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLogs(arg0: string, arg1: string): Promise<Array<HabitLog>> {
        if (this.processError) {
            try {
    ...
    async getLogsForHabit(arg0: string, arg1: string, arg2: string): Promise<Array<HabitLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLogsForHabit(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSharedTracker(arg0: string): Promise<{
        logs: Array<HabitLog>;
        habits: Array<Habit>;
    } | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSharedTracker(arg0);
    ...
    async logHabit(arg0: string, arg1: string, arg2: boolean, arg3: string): Promise<HabitLog> {
        if (this.processError) {
            try {
                const result = await this.actor.logHabit(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeHabit(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
